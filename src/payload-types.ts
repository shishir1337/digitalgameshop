...
export interface HeroSlide {
  id: number;
  /**
   * Internal title for this slide (not displayed on frontend)
   */
  title: string;
  /**
   * The hero image for this slide
   */
  image: number | Media;
  /**
  ...
  alt: string;
  /**
   * URL where the slide should link to (e.g., /products, /shop)
   */
  link: string;
  /**
   * Hex color code for the gradient background (e.g., #66190d)
   */
  color: string;
  /**
